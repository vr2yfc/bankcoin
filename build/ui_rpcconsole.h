...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        label_wallet_bgcoin = new QLabel(tab_info);
        ...
        gridLayout->addWidget(label_wallet_bgcoin, 0, 0, 1, 1);

        label_61 = new QLabel(tab_info);
        label_61->setObjectName(QString::fromUtf8("label_61"));

        gridLayout->addWidget(label_61, 0, 0, 1, 1);
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "bankcoin - Debug window", 0, QApplication::UnicodeUTF8));
        label_9->setText(QApplication::translate("RPCConsole", "bankcoin Core", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the bankcoin debug log file from the current data directory. This can take a few seconds for large log files.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the bankcoin-Qt help message to get a list with possible bankcoin command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
